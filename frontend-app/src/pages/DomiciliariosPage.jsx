...
function DomiciliariosPage() {
    ...
    const loadDomiciliarios = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/ultima-milla/bodegas/${encodeURIComponent(bodega)}/domiciliarios`, {
    ...
    const handleSelectDomiciliario = (domiciliario) => {
        navigate(`/ultima-milla/domiciliarios/${domiciliario.documento}/pedidos?bodega=${encodeURIComponent(bodega)}`);
    };
