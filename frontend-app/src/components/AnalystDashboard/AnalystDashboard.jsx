...
export default function AnalystDashboard(){
  ...
  const handleDownloadPDF = async (type) => {
    try {
      ...
      if (type === 'novedades') {
        // Filtrar productos que tengan novedades (en campo novedad O en novelties)
        ...
        console.log('📊 Productos con novedades para PDF:', auditsWithNovelties);
        console.log('📊 Primer producto:', auditsWithNovelties[0]?.productos[0]);
